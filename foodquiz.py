...
# This file is provided to you as a starting point for the "foodquiz.py" program of Assignment 2
...
class ProgramGUI:
    ...
    def __init__(self):
        ...
        # See the "Constructor of the GUI Class of foodquiz.py" section of the assignment brief.  
        pass
    ...
    def show_question(self):
        ...
        # See Point 1 of the "Methods in the GUI class of foodquiz.py" section of the assignment brief.
        pass
    ...
    def check_answer(self, choice):   
        ...
        # See Point 2 of the "Methods in the GUI class of foodquiz.py" section of the assignment brief.
        pass
